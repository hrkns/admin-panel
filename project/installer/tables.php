<?php
	$tables = array(
		array(
			"name" => "client", 
				"cascade"=>array("address", "documentation", "media", "organization", "status")
		),
		...
		array(
			"name" => "organization", 
				"cascade"=>array("address", "media", "payment_method_bank", "payment_method_credit_card", "payment_method_electronic", "documentation", "status")
		),
			...
			array(
				"name" => "organization_documentation", 
					"cascade"=>array()
			),
			...
			array(
				"name" => "organization_payment_method_bank", 
					"cascade"=>array()
			),

			array(
				"name" => "organization_payment_method_credit_card", 
					"cascade"=>array()
			),

			array(
				"name" => "organization_payment_method_electronic", 
					"cascade"=>array()
			),
