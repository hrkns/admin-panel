...
- Apache profile runnable: yes (`modernization/docker-compose.phase3.yml --profile apache`)
- Nginx + PHP-FPM profile runnable: yes (`modernization/docker-compose.phase3.yml --profile nginx`)
- DB credential/runtime alignment for containers implemented: yes (`DB_*` env contract in `modernization/docker-compose.phase3.yml`)
