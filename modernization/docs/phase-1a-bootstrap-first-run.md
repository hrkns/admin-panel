...
**Evidence**
- `modernization/phase1a/evidence/00-current-failure.md`
...
**Evidence**
- `modernization/phase1a/evidence/01-runtime-setup.md`
...
**Evidence**
- `modernization/phase1a/evidence/02-dependencies.md`
...
**Evidence**
- `modernization/phase1a/evidence/03-db-and-settings.md`
...
**Evidence**
- `modernization/phase1a/evidence/04-first-startup.md`
...
**Evidence**
- `modernization/phase1a/signoff.md`
...
- If Phase 1A used PHP 7.4 fallback, this must be explicitly recorded in `modernization/phase1a/signoff.md` as an unresolved gap against the PHP 8.2+ target.
