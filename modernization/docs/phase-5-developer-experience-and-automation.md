...
- Added `modernization/docker-compose.phase5.yml` with:
...
- Added `modernization/scripts/setup-phase5.ps1`.
- Added public entrypoint `scripts/startup.ps1`.
- Script performs:
...
powershell -ExecutionPolicy Bypass -File .\scripts\startup.ps1 -Rebuild -KeepExistingSmtp
```
...
- `startup.ps1` completes without errors.
