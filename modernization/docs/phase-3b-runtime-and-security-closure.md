...
- Phase 3B sign-off document (recommended path: `modernization/phase3b/signoff.md`).

## Implementation Checkpoint (Current)

- Runtime images aligned to PHP 8.2+ for both Phase 3 profiles:
	- `modernization/docker/php/Dockerfile.phase3-apache`
	- `modernization/docker/php/Dockerfile.phase3-fpm`
- Phase 3 compose Apache profile now builds from `modernization/docker/php/Dockerfile.phase3-apache`.
- Validation evidence captured in `modernization/phase3b/signoff.md` (compose profile resolution + image build verification + live smoke checks).
...
- Live smoke evidence in `modernization/phase3b/signoff.md` shows HTTP 200 on both profiles under PHP 8.2.
- Security remediation closure record captured in:
	- `modernization/phase3b/evidence/01-secret-history-remediation-closure.md`

## Sign-Off Artifacts

- `modernization/phase3b/signoff.md`
- `modernization/phase3b/evidence/01-secret-history-remediation-closure.md`
