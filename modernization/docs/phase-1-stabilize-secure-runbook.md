...
- `modernization/docs/phase-1a-bootstrap-first-run.md`
...
- `modernization/phase1/README.md`
- `modernization/phase1/evidence/*.md`
- `modernization/phase1/manifest/sha256.txt`
- `modernization/phase1/signoff.md`
...
**Evidence to capture**
- `modernization/phase1/evidence/00-runtime-fingerprint.md`
...
**Evidence to capture**
- `modernization/phase1/evidence/01-snapshot-created.md`
- `modernization/phase1/manifest/sha256.txt`
...
**Evidence to capture**
- `modernization/phase1/evidence/02-credential-rotation.md`
...
**Evidence to capture**
- `modernization/phase1/evidence/03-smoke-before.md`
- `modernization/phase1/evidence/04-smoke-after.md`
...
**Evidence to capture**
- `modernization/phase1/evidence/05-recovery-drill.md`
...
### Template A — Runtime Fingerprint (`modernization/phase1/evidence/00-runtime-fingerprint.md`)
```markdown
# Runtime Fingerprint
- Date:
- Operator:
...
### Template B — Credential Rotation (`modernization/phase1/evidence/02-credential-rotation.md`)
```markdown
...
### Template C — Smoke Result (`modernization/phase1/evidence/04-smoke-after.md`)
```markdown
...
### Template D — Sign-Off (`modernization/phase1/signoff.md`)
```markdown
# Phase 1 Sign-Off
- Date:
- Approver(s):
