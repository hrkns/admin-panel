...
- Follow the runbook in `modernization/docs/phase-1-stabilize-secure-runbook.md`.
...
Prerequisite:
- If the app is not currently runnable, complete `modernization/docs/phase-1a-bootstrap-first-run.md` before using this folder.
