...
1. `powershell -ExecutionPolicy Bypass -File .\scripts\startup.ps1`
2. `docker compose -f modernization/docker-compose.phase5.yml ps`
...
- `scripts/startup.ps1`
- `modernization/docs/phase-5-developer-experience-and-automation.md`
- `modernization/docker-compose.phase5.yml`
- `modernization/scripts/setup-phase5.ps1`
