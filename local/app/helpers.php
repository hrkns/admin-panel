<?php
	...
	define("WEB_URL", 							WEBHOST);		//buscar una manera de obtener esto automaticamente
	define("WEB_ROOT", 							__REMOTE__?"":"/admin-panel"); 			//buscar una manera de obtener esto automaticamente
	define("PROJECT_FOLDER",					__REMOTE__?"":"/admin-panel");			//buscar una manera de obtener esto automaticamente
	...
	define("DEFAULT_LANGUAGE", 					$globalPreferences["default_language_system"]);
	...
	function sendEmail($config){
        ...
        $mail->Port = 465;
        $mail->Username = "jrosendo2k@gmail.com";
        $mail->Password = "8088yp4g3";
        $mail->Timeout=5;
        $mail->set('X-Priority', '1');
        $email_from = $mail->Username;
        $name_from = "Administrator";
	...
	function generateMultilingual($str){
        ...
        foreach ($tknsLanguages as $key => $value) {$tknsLanguages[$key] = $str;}
	...
	require_once "constants_operations.php";
	require_once "constants_actions.php";
	require_once "constants_statuses.php";
	//require_once "constants_languages.php";
	require_once "constants_http_codes.php";
	require_once "constants_http_messages.php";
