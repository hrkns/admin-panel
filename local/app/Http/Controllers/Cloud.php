...
class Cloud extends Controller{
	public function createDirs(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["CREATE_DIRECTORIES"]
	    ]);
	...
	public function createFiles(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["CREATE_FILES"]
	    ]);
	...
	public function uploadFilesInfo(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["UPLOAD_FILES_INFO"]
	    ]);
	...
	public function uploadFilesFile(Request $request, $id){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["UPLOAD_FILES_FILES"]
	    ]);
	...
	public function directoryContent(Request $request, $id){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["GET_DIRECTORY_CONTENT"]
	    ]);
	...
	private function remove_directory($request, $id, $moveto = null){
		...
		if($move_to == "root"){
			$move_to = null;
		}else if(!is_numeric($move_to) || count(Directory::where("id", "=", $move_to)->where("id_user", "=", $request->session()->get("iduser"))) == 0){
			$move_to = false;
		}
	...
	public function removeDir(Request $request, $id){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["DELETE_DIRECTORY"]
	    ]);
	...
	public function removeFile(Request $request, $id){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["REMOVE_FILE"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function updateDir(Request $request, $id){
		...
		$item->__update__();
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["UPDATE_DIRECTORY"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function updateFile(Request $request, $id){
		...
		$item->__update__();
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["UPDATE_FILE_INFO"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function removeFiles(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["DELETE_FILE"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function removeDirectories(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["REMOVE_DIRECTORIES"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function search(Request $request){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["SEARCH_FILES_AND_DIRECTORIES"]
	    ]);
	...
	public function downloadFile(Request $request, $id){
		...
		if(file_exists($filepath)){
		    ...
		    __ACTIVITY__([
		        "operation" => $GLOBALS["__OPERATION__"]["DOWNLOAD_FILE"]
		    ]);
	...
	public function compression(Request $request){
		...
		}else if(!is_numeric($save_compressed_in) || count(Directory::where("id", "=", $save_compressed_in)->where("id_user", "=", $request->session()->get("iduser"))) == 0){
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["DOWNLOAD_COMPRESSION"]
	    ]);
	...
	public function downloadDirectory(Request $request, $id){
		...
		if(is_file(CLOUD_ROUTE.$hash.".zip")){
		    ...
		    ob_end_clean();
		    __ACTIVITY__([
		        "operation" => $GLOBALS["__OPERATION__"]["DOWNLOAD_COMPRESSED_DIRECTORY"]
		    ]);
		}else{
	...
	public function setParent(Request $request){
		...
		if($new_parent == "root"){
			$new_parent = null;
		}else if(!is_numeric($new_parent) || count(Directory::where("id", "=", $new_parent)->where("id_user", "=", $request->session()->get("iduser"))) == 0){
			$new_parent = false;
		}
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["SET_PARENT_DIRECTORY_OF_FILES_AND_DIRECTORIES"]
	    ]);
		return \Response::json([], 200);
	}
	...
	public function copyItemsTo(Request $request){
		...
		if($destiny == "root"){
			$destiny = null;
		}else if(!is_numeric($destiny) || count(Directory::where("id", "=", $destiny)->where("id_user", "=", $request->session()->get("iduser"))) == 0){
			$destiny = false;
		}
	    ...
	    __ACTIVITY__([
	        "operation" => $GLOBALS["__OPERATION__"]["COPY_FILES_AND_DIRECTORIES"]
	    ]);
