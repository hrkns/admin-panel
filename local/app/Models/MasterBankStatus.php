...
use App\Models\CreatedMasterBankStatus;
use App\Models\UpdatedMasterBankStatus;
use App\Models\DeletedMasterBankStatus;
use Request;
class MasterBankStatus extends Model
{
	protected $table = 'ap_master_bank_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterBankStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterBankStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterBankStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
