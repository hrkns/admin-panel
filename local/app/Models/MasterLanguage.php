...
use App\Models\CreatedMasterLanguage;
use App\Models\UpdatedMasterLanguage;
use App\Models\DeletedMasterLanguage;
use Request;
use App\Models\MasterLanguageStatus;
class MasterLanguage extends Model
{
	protected $table = 'ap_master_language';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterLanguage;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterLanguage;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterLanguage;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\MasterLanguageStatus', 'id_item');
	}
