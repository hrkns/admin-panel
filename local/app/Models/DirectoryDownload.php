...
use App\Models\CreatedDirectoryDownload;
use App\Models\UpdatedDirectoryDownload;
use App\Models\DeletedDirectoryDownload;
use Request;
class DirectoryDownload extends Model
{
	protected $table = 'ap_directory_download';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedDirectoryDownload;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedDirectoryDownload;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedDirectoryDownload;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
