...
use App\Models\CreatedPanelAdminSound;
use App\Models\UpdatedPanelAdminSound;
use App\Models\DeletedPanelAdminSound;
use Request;
use App\Models\PanelAdminSoundStatus;
class PanelAdminSound extends Model
{
	protected $table = 'ap_panel_admin_sound';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminSound;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminSound;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminSound;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\PanelAdminSoundStatus', 'id_item');
	}
