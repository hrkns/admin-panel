...
use App\Models\CreatedCompressedFileInfo;
use App\Models\UpdatedCompressedFileInfo;
use App\Models\DeletedCompressedFileInfo;
use Request;
class CompressedFileInfo extends Model
{
	protected $table = 'ap_compressed_file_info';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedCompressedFileInfo;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedCompressedFileInfo;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedCompressedFileInfo;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
