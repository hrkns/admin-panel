...
use App\Models\CreatedClientDocumentation;
use App\Models\UpdatedClientDocumentation;
use App\Models\DeletedClientDocumentation;
use Request;
class ClientDocumentation extends Model
{
	protected $table = 'ap_client_documentation';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedClientDocumentation;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedClientDocumentation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedClientDocumentation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
