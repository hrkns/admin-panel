...
use App\Models\CreatedUserSectionAmountTimesVisited;
use App\Models\UpdatedUserSectionAmountTimesVisited;
use App\Models\DeletedUserSectionAmountTimesVisited;
use Request;
class UserSectionAmountTimesVisited extends Model
{
	protected $table = 'ap_user_section_amount_times_visited';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserSectionAmountTimesVisited;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserSectionAmountTimesVisited;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserSectionAmountTimesVisited;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
