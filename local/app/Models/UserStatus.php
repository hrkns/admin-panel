...
use App\Models\CreatedUserStatus;
use App\Models\UpdatedUserStatus;
use App\Models\DeletedUserStatus;
use Request;
class UserStatus extends Model
{
	protected $table = 'ap_user_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
