...
use App\Models\CreatedSale;
use App\Models\UpdatedSale;
use App\Models\DeletedSale;
use Request;
use App\Models\SaleStatus;
class Sale extends Model
{
	protected $table = 'ap_sale';
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\SaleStatus', 'id_item');
	}
