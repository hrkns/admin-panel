...
use App\Models\CreatedMasterMediaStatus;
use App\Models\UpdatedMasterMediaStatus;
use App\Models\DeletedMasterMediaStatus;
use Request;
class MasterMediaStatus extends Model
{
	protected $table = 'ap_master_media_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterMediaStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterMediaStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterMediaStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
