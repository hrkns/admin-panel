...
use App\Models\CreatedDirectoryUserPermises;
use App\Models\UpdatedDirectoryUserPermises;
use App\Models\DeletedDirectoryUserPermises;
use Request;
class DirectoryUserPermises extends Model
{
	protected $table = 'ap_directory_user_permises';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedDirectoryUserPermises;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedDirectoryUserPermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedDirectoryUserPermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
