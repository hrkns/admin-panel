...
use App\Models\CreatedPanelAdminActionStatus;
use App\Models\UpdatedPanelAdminActionStatus;
use App\Models\DeletedPanelAdminActionStatus;
use Request;
class PanelAdminActionStatus extends Model
{
	protected $table = 'ap_panel_admin_action_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminActionStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminActionStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminActionStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
