...
use App\Models\CreatedPanelAdminSectionTermStatus;
use App\Models\UpdatedPanelAdminSectionTermStatus;
use App\Models\DeletedPanelAdminSectionTermStatus;
use Request;
class PanelAdminSectionTermStatus extends Model
{
	protected $table = 'ap_panel_admin_section_term_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminSectionTermStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminSectionTermStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminSectionTermStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
