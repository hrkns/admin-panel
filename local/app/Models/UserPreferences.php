...
use App\Models\CreatedUserPreferences;
use App\Models\UpdatedUserPreferences;
use App\Models\DeletedUserPreferences;
use Request;
class UserPreferences extends Model
{
	protected $table = 'ap_user_preferences';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserPreferences;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserPreferences;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserPreferences;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
