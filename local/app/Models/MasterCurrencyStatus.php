...
use App\Models\CreatedMasterCurrencyStatus;
use App\Models\UpdatedMasterCurrencyStatus;
use App\Models\DeletedMasterCurrencyStatus;
use Request;
class MasterCurrencyStatus extends Model
{
	protected $table = 'ap_master_currency_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterCurrencyStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterCurrencyStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterCurrencyStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
