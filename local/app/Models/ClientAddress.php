...
use App\Models\CreatedClientAddress;
use App\Models\UpdatedClientAddress;
use App\Models\DeletedClientAddress;
use Request;
class ClientAddress extends Model
{
	protected $table = 'ap_client_address';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedClientAddress;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedClientAddress;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedClientAddress;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
