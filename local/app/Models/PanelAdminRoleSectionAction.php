...
use App\Models\CreatedPanelAdminRoleSectionAction;
use App\Models\UpdatedPanelAdminRoleSectionAction;
use App\Models\DeletedPanelAdminRoleSectionAction;
use Request;
class PanelAdminRoleSectionAction extends Model
{
	protected $table = 'ap_panel_admin_role_section_action';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminRoleSectionAction;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminRoleSectionAction;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminRoleSectionAction;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
