...
use App\Models\CreatedEventStatus;
use App\Models\UpdatedEventStatus;
use App\Models\DeletedEventStatus;
use Request;
class EventStatus extends Model
{
	protected $table = 'ap_event_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedEventStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedEventStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedEventStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
