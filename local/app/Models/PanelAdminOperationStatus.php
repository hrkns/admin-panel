...
use App\Models\CreatedPanelAdminOperationStatus;
use App\Models\UpdatedPanelAdminOperationStatus;
use App\Models\DeletedPanelAdminOperationStatus;
use Request;
class PanelAdminOperationStatus extends Model
{
	protected $table = 'ap_panel_admin_operation_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminOperationStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminOperationStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminOperationStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
