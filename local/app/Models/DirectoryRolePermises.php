...
use App\Models\CreatedDirectoryRolePermises;
use App\Models\UpdatedDirectoryRolePermises;
use App\Models\DeletedDirectoryRolePermises;
use Request;
class DirectoryRolePermises extends Model
{
	protected $table = 'ap_directory_role_permises';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedDirectoryRolePermises;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedDirectoryRolePermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedDirectoryRolePermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
