...
use App\Models\CreatedMasterDocumentation;
use App\Models\UpdatedMasterDocumentation;
use App\Models\DeletedMasterDocumentation;
use Request;
use App\Models\MasterDocumentationStatus;
class MasterDocumentation extends Model
{
	protected $table = 'ap_master_documentation';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterDocumentation;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterDocumentation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterDocumentation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function create_Status($args){
		if(gettype($args) == "object"){
			...
			if(isAssoc($args)){
				$obj = new MasterDocumentationStatus;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\MasterDocumentationStatus', 'id_item');
	}
