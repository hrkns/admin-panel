...
use App\Models\CreatedMasterAdministrativeDivisionInstanceStatus;
use App\Models\UpdatedMasterAdministrativeDivisionInstanceStatus;
use App\Models\DeletedMasterAdministrativeDivisionInstanceStatus;
use Request;
class MasterAdministrativeDivisionInstanceStatus extends Model
{
	protected $table = 'ap_master_administrative_division_instance_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterAdministrativeDivisionInstanceStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterAdministrativeDivisionInstanceStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterAdministrativeDivisionInstanceStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
