...
use App\Models\CreatedPanelAdminSoundStatus;
use App\Models\UpdatedPanelAdminSoundStatus;
use App\Models\DeletedPanelAdminSoundStatus;
use Request;
class PanelAdminSoundStatus extends Model
{
	protected $table = 'ap_panel_admin_sound_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminSoundStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminSoundStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminSoundStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
