...
use App\Models\CreatedMasterAdministrativeDivisionInstanceParent;
use App\Models\UpdatedMasterAdministrativeDivisionInstanceParent;
use App\Models\DeletedMasterAdministrativeDivisionInstanceParent;
use Request;
class MasterAdministrativeDivisionInstanceParent extends Model
{
	protected $table = 'ap_master_administrative_division_instance_parent';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterAdministrativeDivisionInstanceParent;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterAdministrativeDivisionInstanceParent;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterAdministrativeDivisionInstanceParent;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
