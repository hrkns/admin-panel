...
use App\Models\CreatedPanelAdminAction;
use App\Models\UpdatedPanelAdminAction;
use App\Models\DeletedPanelAdminAction;
use Request;
use App\Models\PanelAdminActionStatus;
class PanelAdminAction extends Model
{
	protected $table = 'ap_panel_admin_action';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminAction;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminAction;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminAction;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function create_Status($args){
		if(gettype($args) == "object"){
			...
			if(isAssoc($args)){
				$obj = new PanelAdminActionStatus;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\PanelAdminActionStatus', 'id_item');
	}
