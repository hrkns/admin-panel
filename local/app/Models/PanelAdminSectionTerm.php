...
use App\Models\CreatedPanelAdminSectionTerm;
use App\Models\UpdatedPanelAdminSectionTerm;
use App\Models\DeletedPanelAdminSectionTerm;
use Request;
use App\Models\PanelAdminSectionTermStatus;
class PanelAdminSectionTerm extends Model
{
	protected $table = 'ap_panel_admin_section_term';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminSectionTerm;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminSectionTerm;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminSectionTerm;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function create_Status($args){
		if(gettype($args) == "object"){
			...
			if(isAssoc($args)){
				$obj = new PanelAdminSectionTermStatus;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\PanelAdminSectionTermStatus', 'id_item');
	}
