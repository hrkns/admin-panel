...
use App\Models\CreatedThreadSpeaker;
use App\Models\UpdatedThreadSpeaker;
use App\Models\DeletedThreadSpeaker;
use Request;
class ThreadSpeaker extends Model
{
	protected $table = 'ap_thread_speaker';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedThreadSpeaker;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedThreadSpeaker;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedThreadSpeaker;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
