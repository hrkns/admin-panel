...
use App\Models\CreatedUserRole;
use App\Models\UpdatedUserRole;
use App\Models\DeletedUserRole;
use Request;
class UserRole extends Model
{
	protected $table = 'ap_user_role';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserRole;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserRole;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserRole;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
