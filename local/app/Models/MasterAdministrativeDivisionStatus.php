...
use App\Models\CreatedMasterAdministrativeDivisionStatus;
use App\Models\UpdatedMasterAdministrativeDivisionStatus;
use App\Models\DeletedMasterAdministrativeDivisionStatus;
use Request;
class MasterAdministrativeDivisionStatus extends Model
{
	protected $table = 'ap_master_administrative_division_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterAdministrativeDivisionStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterAdministrativeDivisionStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterAdministrativeDivisionStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
