...
use App\Models\CreatedPanelAdminRoleStatus;
use App\Models\UpdatedPanelAdminRoleStatus;
use App\Models\DeletedPanelAdminRoleStatus;
use Request;
class PanelAdminRoleStatus extends Model
{
	protected $table = 'ap_panel_admin_role_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPanelAdminRoleStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPanelAdminRoleStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPanelAdminRoleStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
