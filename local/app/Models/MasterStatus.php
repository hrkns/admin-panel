...
use App\Models\CreatedMasterStatus;
use App\Models\UpdatedMasterStatus;
use App\Models\DeletedMasterStatus;
use Request;
use App\Models\MasterStatusStatus;
class MasterStatus extends Model
{
	protected $table = 'ap_master_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\MasterStatusStatus', 'id_item');
	}
