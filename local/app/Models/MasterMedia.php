...
use App\Models\CreatedMasterMedia;
use App\Models\UpdatedMasterMedia;
use App\Models\DeletedMasterMedia;
use Request;
use App\Models\MasterMediaStatus;
class MasterMedia extends Model
{
	protected $table = 'ap_master_media';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterMedia;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterMedia;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterMedia;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\MasterMediaStatus', 'id_item');
	}
