...
use App\Models\CreatedMasterEpayment;
use App\Models\UpdatedMasterEpayment;
use App\Models\DeletedMasterEpayment;
use Request;
use App\Models\MasterEpaymentStatus;
class MasterEpayment extends Model
{
	protected $table = 'ap_master_epayment';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterEpayment;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterEpayment;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterEpayment;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\MasterEpaymentStatus', 'id_item');
	}
