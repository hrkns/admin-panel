...
use App\Models\CreatedPurchase;
use App\Models\UpdatedPurchase;
use App\Models\DeletedPurchase;
use Request;
use App\Models\PurchaseStatus;
class Purchase extends Model
{
	protected $table = 'ap_purchase';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedPurchase;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedPurchase;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedPurchase;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function read_Status($args = array()){
		return $this->hasMany('App\Models\PurchaseStatus', 'id_item');
	}
