...
use App\Models\CreatedMasterEpaymentStatus;
use App\Models\UpdatedMasterEpaymentStatus;
use App\Models\DeletedMasterEpaymentStatus;
use Request;
class MasterEpaymentStatus extends Model
{
	protected $table = 'ap_master_epayment_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedMasterEpaymentStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedMasterEpaymentStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedMasterEpaymentStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
