...
use App\Models\CreatedUserMedia;
use App\Models\UpdatedUserMedia;
use App\Models\DeletedUserMedia;
use Request;
class UserMedia extends Model
{
	protected $table = 'ap_user_media';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserMedia;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserMedia;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserMedia;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
