...
use App\Models\CreatedUserSignupConfirmation;
use App\Models\UpdatedUserSignupConfirmation;
use App\Models\DeletedUserSignupConfirmation;
use Request;
class UserSignupConfirmation extends Model
{
	protected $table = 'ap_user_signup_confirmation';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedUserSignupConfirmation;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedUserSignupConfirmation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedUserSignupConfirmation;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
