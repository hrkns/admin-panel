...
use App\Models\CreatedSaleStatus;
use App\Models\UpdatedSaleStatus;
use App\Models\DeletedSaleStatus;
use Request;
class SaleStatus extends Model
{
	protected $table = 'ap_sale_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedSaleStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedSaleStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedSaleStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
