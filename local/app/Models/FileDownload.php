...
use App\Models\CreatedFileDownload;
use App\Models\UpdatedFileDownload;
use App\Models\DeletedFileDownload;
use Request;
class FileDownload extends Model
{
	protected $table = 'ap_file_download';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedFileDownload;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedFileDownload;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedFileDownload;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
