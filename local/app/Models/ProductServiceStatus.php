...
use App\Models\CreatedProductServiceStatus;
use App\Models\UpdatedProductServiceStatus;
use App\Models\DeletedProductServiceStatus;
use Request;
class ProductServiceStatus extends Model
{
	protected $table = 'ap_product_service_status';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedProductServiceStatus;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedProductServiceStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedProductServiceStatus;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
