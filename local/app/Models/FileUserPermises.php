...
use App\Models\CreatedFileUserPermises;
use App\Models\UpdatedFileUserPermises;
use App\Models\DeletedFileUserPermises;
use Request;
class FileUserPermises extends Model
{
	protected $table = 'ap_file_user_permises';
	...
	public function __create__(){
		...
		/******/
		/*your code*/
		$complement = new CreatedFileUserPermises;
	...
	public function __update__(){
		...
		/******/
		/*your code*/
		$complement = new UpdatedFileUserPermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
	...
	public function __delete__(){
		...
		/******/
		/*your code*/
		$complement = new DeletedFileUserPermises;
		$complement->id_item = $this->id;
		$complement->info = $info;
		$complement->hash_operation = HASH_OPERATION;
